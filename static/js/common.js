...
var setFroala = function(selector, option, events_option){
  ...
  FroalaEditor.DefineIcon('fontSize', {SRC: '//vendor-cdn.imweb.me/images/froala/font_size_white.png', template: 'image'});
  ...
  var default_events_option = {
    ...
    const that = this;
      ...
      function resizeToolbar(){
        ...
        if(is_custom_mobile){
          $('.custom-theme.fr-toolbar .fr-command.fr-btn[data-cmd="fontSize"] img').attr('src', '//vendor-cdn.imweb.me/images/froala/font_size_black.png');
          // 요소에 맞게 길이 조절
          var tbPadding = 10;
          var tbWidth = 0;
          ...
          $('.custom-theme.fr-toolbar .fr-command.fr-btn[data-cmd="fontSize"] img').attr('src', '//vendor-cdn.imweb.me/images/froala/font_size_white.png');
